        ...
        return getElementFromHtml(`
            <div class="column" data-type="${TYPES.COLUMN}" data-column-id="${columnId}">
                <div class="column-header">
                    ...
                    <button class="delete-column" data-action="${ACTIONS.DELETE_COLUMN}" data-column-id="${columnId}>&#100066</button>
                </div>
                <ul class="tasks"></ul>
                <button class="add-task" data-action"${ACTIONS.ADD_TASK}" data-column-id="${columnId}">Add</div>
            </div>
        `)
    }
