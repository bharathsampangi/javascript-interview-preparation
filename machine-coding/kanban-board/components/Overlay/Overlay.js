import { addTask, addColumn } from "../../services/API.js"
import { ACTIONS, ADD_COLUMN_EVENT, ADD_TASK_EVENT, getElementFromHtml } from "../../utils.js"
...
export class Overlay {
    ...
    addColumn(e) {
        ...
        let newColumnEl = new Column(newColumn.columnId, newColumn.title).domElement
